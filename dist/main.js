...
(function() {
  var $, addClass, animateElement, dynamicEvent, eventListeners, form, itemClass, link, links, list, lists, removeClass, removeElement, replaceClass, _i, _j, _len, _len1;
  ...
  animateElement = function() {
    ...
    this.className += removeClass;
    _results = [];
    for (_i = 0, _len = eventListeners.length; _i < _len; _i++) {
      listener = eventListeners[_i];
      _results.push(this.addEventListener(listener, (function(event) {
  ...
  for (_i = 0, _len = lists.length; _i < _len; _i++) {
    ...
    form.onsubmit = function() {
      return dynamicEvent(this, this.parentNode);
    };
  }

  dynamicEvent = function(el, parent) {
    var dynamicElement, dynamicValue, li;
